...
# TODO: define eastern radar stations
STATION_REGIONS = {
    "Birdcast"   : [ "KCLE", "KBUF", "KTYX"],
    "my_region"  : [ "KDOX", "KLIX", "KBGM", "KLCH" ],
    "north_east" : [ "KBGM", "KBOX", "KBUF", "KCBW", "KCCX", "KCXX", "KDIX", "KDOX", "KENX", "KGYX", "KLWX", "KOKX", "KTYX" ],
    "east"       : [ "KILX", "KLCH", "KMXX", "KHTX", "KJKL", "KLSX", "KCXX", "KDTX", "KMQT", "KSHV", "KFSD", "KCAE", "KBYX", "KDLH", "KNQA", "KRAX", "KBRO", "KLTX", "KMPX", "KICT", "KTLX", "KVAX", "KTLH", "KMHX", "KTBW", "KILN", "KTYX", "KLZK", "KMRX", "KOKX", "KIND", "KDIX", "KBMX", "KMKX", "KEVX", "KGWX", "KEOX", "KLIX", "KPAH", "KINX", "KSRX", "KAMX", "KGYX", "KPBZ", "KENX", "KFCX", "KTWX", "KLOT", "KAPX", "KJGX", "KHPX", "KDGX", "KLWX", "KBOX", "KFWS", "KDOX", "KARX", "KIWX", "KOHX", "KMLB", "KCLX", "KRLX", "KOAX", "KBUF", "KCLE", "KCRP", "KVWX", "KGRK", "KJAX", "KFFC", "KDVN", "KMOB", "KSGF", "KCCX", "KGSP", "KDMX", "KBGM", "KPOE", "KEAX", "KGRB", "KHGX", "KMVX", "KLVX", "KGRR", "KAKQ", "KCBW"],
